...
//#if UNITY_EDITOR
//    public float CameraShakeViolence;
//    void Update()
//    {
//        if (Input.GetKeyDown(KeyCode.L))
//        {
//            float shakeViolence = 1 / (5 * CameraShakeViolence);
...
//#endif
	...
	public void StartShaking(float shakeDistance, float totalShakeAngle)
	{
		var halfMaxShakeDistance = shakeDistance / 2;
		actualStartingShakeDistance = new Vector3(Random.Range(-halfMaxShakeDistance, halfMaxShakeDistance), Random.Range(-halfMaxShakeDistance, halfMaxShakeDistance), Random.Range(-halfMaxShakeDistance, halfMaxShakeDistance));
		var halfMaxShakeAngle = totalShakeAngle / 2;
		actualStartingRotationAmount = new Quaternion(Random.Range(-halfMaxShakeAngle, halfMaxShakeAngle), Random.Range(-halfMaxShakeAngle, halfMaxShakeAngle), Random.Range(-halfMaxShakeAngle, halfMaxShakeAngle), 1);
