...
public class WeaponController2 : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        EventManager.Invoke(EventName.UpdateBulletCount, _currentBulletCount); // G?i thông báo v? s? l??ng ??n ban ??u
    ...
    private void Shoot()
    {
        ...
        _animation["Fire"].speed = 2.0f; // T?ng t?c ?? phát clip "Fire" g?p ?ôi
